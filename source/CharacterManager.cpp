	...
	:m_characters(pool_capacity, pool_allowDynamic)
{
	...
	m_defaultStatus.emplace(1, CharacterStatus{ "ゆうしゃ",10,50,50 });
	m_defaultStatus.emplace(2, CharacterStatus{ "どれい", 20,20,100 });
	m_defaultStatus.emplace(3, CharacterStatus{ "ドラゴン",500,40,100});
